...
const Input = <T extends FieldValues>({id, title, type, value, autoComplete, placeholder, showRequired, errors, register, setter, setValue}:InputProps<T>) => {
    return (
        <div className="w-full">
            ...
            <input
                ...
                className={"w-full my-1 p-2 bg-gray-50 border border-gray-300 px-3 text-gray-900 text-sm rounded-lg " +
